# Copilot Instructions — `school-committee`
...
- **Authoritative path**: `/home/ssf/Documents/Github/school-committee` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/school-committee.git`, branch `main`.

...
We need to have as much gamification as possible to involve users more in this site. it could be Tasks Champion (completed more tasks). Idea Generator (created lots of feedbacks/ideas), Voter (left more feedback than others on all ideas) and Most popular Idea (gathered more stars) etc. It is just as examples but you can propose and implement much more. Like badge for registration, medal for filling data for his children, Registered after approval of school_staff, Member of school committee, Teacher etc. Registered users could vote also for comments on that discussion. And best commenter receives badge for that. Some Hall Of Fame with Top acieved users. The goal is to have every user to be appreciated with as much as possible marks, stars, medals, badges etc. It will stimulate them to be more active.
When registered users click on the user profile they should see all his ranks, achievements.
For public there should be visible only feedbacks, ideas, their stars but no names visible due to the GDPR. Only registered users could see names.
All feedback ideas should be published immediatelly and everybody could vote for them. Idea author cannot vote for his adeas.

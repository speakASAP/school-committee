...
REQUIRED_FILES = ["BUSINESS.md","GOALS.md","SYSTEM.md","AGENTS.md","CLAUDE.md","TASKS.md","README.md","docs/33-openapi.yaml","docs/intent-preservation/README.md","docs/intent-preservation/constitution.md","docs/intent-preservation/project-invariants.md","docs/intent-preservation/agent-rules.md","docs/intent-preservation/documentation-completeness-standard.md","docs/intent-preservation/sensitive-data-policy.md","docs/intent-preservation/operational-gates.md","docs/intent-preservation/context-packages.md","docs/intent-preservation/tasks/TASK-IPS-001-standard-adoption.md","docs/intent-preservation/execution-plans/EP-IPS-001-standard-adoption.md","docs/intent-preservation/context-packages/CP-IPS-001-standard-adoption.md","docs/intent-preservation/goal-impact/GOAL-IMPACT-IPS-001-standard-adoption.md","docs/intent-preservation/validation/VAL-IPS-001-standard-adoption.md"]
REQUIRED_SECTIONS = {"docs/intent-preservation/tasks/TASK-IPS-001-standard-adoption.md":["Objective","Upstream Links","Goal Impact","Project Invariant Impact","Sensitive-Data Classification","Contract/Schema Impact","Replay/Determinism Impact","Scope","Non-Goals","Acceptance Criteria","Required Context","Validation Task","Required Gates","Execution Plan Requirement"],"docs/intent-preservation/execution-plans/EP-IPS-001-standard-adoption.md":["Metadata","Upstream Traceability","Goal Impact","Project Invariants","Sensitive-Data Handling","Contract Validation Plan","Replay/Determinism Plan","Scope","Non-Goals","Files to Inspect","Files to Create","Files to Modify","Files That Must Not Be Modified","Implementation Steps","Test Plan","Validation Plan","Gate Commands","Documentation Updates","Rollback Plan","Agent Handoff Prompt","Completion Checklist"],"docs/intent-preservation/context-packages/CP-IPS-001-standard-adoption.md":["Target task","Upstream traceability","Included documents","Excluded documents","Constraints","Agent prompt","Validation instructions"],"docs/intent-preservation/validation/VAL-IPS-001-standard-adoption.md":["Artifact validated","Validation scope","Evidence","Gate evidence","Invariant evidence","Sensitive-data scan evidence","Replay and determinism evidence","Passed criteria","Failed criteria","Deviations","Recommendation"]}
...
def audit(root: Path):
    ...
    for p in sorted((root/"docs"/"intent-preservation").rglob("*.md")):
